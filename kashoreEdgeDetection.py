...
# lane_image_2 = cv2.cvtColor(image2, cv2.COLOR_BGR2HLS)
# plt.imshow(lane_image_2)
# plt.show()
# # nearly no color change between two areas leads to a problem, so hls creates a new color space which
# # makes it easier to recognize for the pc
...
# # in the image, it labels any colors that are in the range between lower and upper
# # this coe searches for one color. for 2 read:
...
####****************************************************************###
##Contour Detection:
# More Resource https://learnopencv.com/contour-detection-using-opencv-python-c/
image2 = cv2.imread('solidWhiteRight.jpg')
lane_image_2 = np.copy(image2)
print(lane_image_2.shape)
# lane_image_2 = cv2.cvtColor(lane_image_2,cv2.COLOR_BGR2RGB)
