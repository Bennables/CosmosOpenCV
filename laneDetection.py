...
import edgeDetectForLaneDetection as edge # Handles the detection of lane lines
...
file_size = (852,480) # Assumes 1920x1080 mp4
...
output_filename = 'new_outside_lanes.mp4'
...
poopybutt = VESC(serial_port='COM12')
...
class Lane:
  ...
  #   # original BGR video frame.
    ...
    mask = cv2.inRange(hls, lower_threshold, upper_threshold)

    #Yellow color mask

    # lower_threshold2 = np.uint8([50, 100, 100])

    # upper_threshold2 = np.uint8([255, 200, 200])

    # yellow_mask = cv2.inRange(hls, lower_threshold2, upper_threshold2)
...
def main():
  ...
  while cap.isOpened():
    ...
    if success:
      ...
      poopyButtTimeout(1,poopybutt,vesc_angle,0.5)
